...
github_url_exe = "https://raw.githubusercontent.com/HyphenK/mltdkei_v3/exe/"
...
def update_exe():
    ...
    download_file = "mltdkei_v30E.exe"
    response = requests.get(github_url_exe+"mltdkei_v30E.exe", stream=True)
